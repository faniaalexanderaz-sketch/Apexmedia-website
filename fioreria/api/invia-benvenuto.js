/* =============================================================
   ANTICA FIORERIA DEL CENTRO — email di benvenuto con BENVENUTO20
...
module.exports = async function handler(req, res) {
  ...
  try {
    await inviaEmail({
      to: email,
      subject: 'Il tuo 20% di benvenuto — Antica Fioreria del Centro',
      html: emailBenvenuto()
    });
  } catch (err) {
...
function emailBenvenuto() {
  return '' +
    ...
    '  <h1 style="font-size:26px;color:#24352B;margin:0 0 18px;">Il tuo 20% è pronto</h1>' +
    ...
    '    <span style="display:inline-block;background:#2E4B3A;color:#FAFAF7;font-size:20px;font-weight:bold;letter-spacing:.06em;padding:14px 28px;border-radius:999px;">BENVENUTO20</span>' +
    '  </p>' +
