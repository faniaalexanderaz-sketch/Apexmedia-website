...
PAGES.append({"body": f"""
  ...
  <div class="g3 compact" style="margin:4mm 0">
    ...
    {kpi("约 &euro;2.700","次年 2 月可追踪营业额","目前约为每月 &euro;1.030")}
    {kpi("&lt; &euro;18","单位获客成本目标","针对谷歌广告")}
  </div>
  <div class="note amber">
    <h4>必须说清楚的一点</h4>
    <p style="margin-bottom:0">这是一份<strong>预测，不是承诺</strong>。
    它的起点是真实数据（八月谷歌带来 55 位客户，目前每月可追踪营业额约 &euro;1.030，
    即 Treatwell 加上谷歌与 Instagram 的估算），增长假设已公开写明、可逐月核实。营业额估算采用八月记录的客户平均价值，且偏保守，
...
PAGE_FATTURATO = {"body": f"""
  ...
  <h2>两个半月内，预约系统内成交 €1.275</h2>
  <div class="rule"></div>
  <p class="lead">这些不是估算数字，而是 <strong>Treatwell 的销售报告</strong>，随时可以从后台导出。
  统计区间为 <strong>2026 年 7 月 7 日 – 9 月 19 日</strong>，
  即从谷歌广告上线前不久一直到今天。</p>
  <div class="g3 compact" style="margin:5mm 0 4mm">
    {kpi("&euro;1.275","Treatwell 营业额","2026 年 7 月 7 日 &rarr; 9 月 19 日","vio")}
    {kpi("33","已预约的理疗次数","全部来自后台，含增值税")}
    {kpi("&euro;38,6","客单价","每次理疗平均")}
  </div>
  <div class="g2u">
    <div class="card">
      <h4>具体预约了哪些项目</h4>
      <table style="margin-top:2mm">
        <thead><tr><th>项目</th><th class="n">数量</th><th class="n">金额</th></tr></thead>
        <tbody>
          <tr><td class="ch">精油按摩（颈部、背部…）</td><td class="n">11</td><td class="n">€420</td></tr>
          <tr><td class="ch">足底反射疗法</td><td class="n">8</td><td class="n">€275</td></tr>
          <tr><td class="ch">修脚</td><td class="n">8</td><td class="n">€280</td></tr>
          <tr><td class="ch">水疗按摩</td><td class="n">2</td><td class="n">€150</td></tr>
          <tr><td class="ch">指压按摩</td><td class="n">2</td><td class="n">€100</td></tr>
    ...
    <div class="note vio">
      ...
      <p style="margin:2.5mm 0 0"><strong>日均提高 10%</strong>，而且恰恰发生在所有人都认为疲软的月份：
      刚从假期返回、学费和各类活动开销集中到来、工资还没有回到正常节奏。
      如果在这样的条件下节奏还在上升，那么十月 —— 开销消化、天气转冷、肌肉紧张 ——
      才是这项工作真正体现成果的月份。</p>
    </div>
  </div>
  <div class="note amber" style="margin-top:4mm">
    <h4>那些不经过 Treatwell 的部分呢？</h4>
    <p style="margin-bottom:0">这 €1.275 <strong>只是线上预约的部分</strong>。
    来自谷歌的客户几乎都通过电话或 WhatsApp 预约：那部分营业额直接进了收银，
    不经过预约系统，因此不会出现在这份报告里。保守估算为：
    <strong>仅八月一个月，谷歌带来约 €420</strong>，<strong>Instagram 约 €60</strong>，
    依据联系数量和客单价推算。因此该区间的真实总额
    <strong>明显高于 €1.275</strong>，而不是更低。</p>
  </div>
"""}
...
PAGE_ASPETTATIVE = {"body": f"""
  <div class="eyebrow">15 — 预期</div>
  <h2>这项工作可以要求到什么程度：三种方案</h2>
  <div class="rule"></div>
  <p class="lead">每一个营业额目标，都会换算成每天需要服务的确切客户数量。
  以下是未来六个月的三种可能方案，以及各自意味着什么。</p>
  <table style="margin:5mm 0 4mm">
    <thead><tr>
      <th style="width:24%">方案</th><th>有什么变化</th><th class="n">次年 2 月<br/>客户/月</th>
      <th class="n">客户<br/>每天</th><th class="n">可追踪<br/>营业额</th>
    </tr></thead>
    <tbody>
      <tr><td class="ch">A · 维持现状</td>
          <td>广告投入不变，不新增任何动作</td>
          <td class="n">约 95</td><td class="n">约 3</td><td class="n">约 €1.500</td></tr>
      <tr><td class="ch">B · 稳健放大 <span class="pill vio" style="margin-left:2mm">推荐</span></td>
          <td>本文件的计划：加大谷歌预算、内容、再营销、Treatwell 优化</td>
          <td class="n"><strong>约 162</strong></td><td class="n"><strong>约 5–6</strong></td>
          <td class="n"><strong>约 €2.700</strong></td></tr>
      <tr><td class="ch">C · 强力推进</td>
          <td>谷歌预算翻倍以上，Meta 付费投放，季节性推广活动</td>
  ...
  <div class="g2u">
    <div class="note">
      <h4>瓶颈会移动到哪里</h4>
      <ul class="ticks" style="font-size:8.6pt">
        <li><strong>每天 3–4 位客户以内</strong>，瓶颈是我们能创造多少需求：这是我们的工作，我们做得到</li>
        <li><strong>每天 5–6 位</strong>，瓶颈仍是需求，但需要有条理的排期，以及对电话和 WhatsApp 的快速回应</li>
        <li><strong>每天 8 位以上</strong>，瓶颈就不再是广告：而是营业时间、工位数量和店内可用的人手</li>
      </ul>
    </div>
    <div class="note amber">
      <h4>把账算清楚</h4>
      <p style="margin-bottom:0">按客单价 <strong>€38,6</strong> 计算，每一个营业额目标
      都对应一个必须完成的理疗数量：<strong>每月 €2.000 = 52 次</strong>（约每天 2 次）·
      <strong>€5.000 = 129 次</strong>（约每天 4 次）· <strong>€10.000 = 259 次</strong>
      （约每天 9 次，全年无休）。再往上，任何广告都帮不上忙：
      如果没有人能把理疗做出来，我们带来的客户就变不成营业额。</p>
    </div>
  </div>
  <div class="cta" style="margin-top:4mm;padding:5mm">
    <h3 style="font-size:11.5pt;margin-bottom:2.5mm">我们能承诺什么，不能承诺什么</h3>
    <div class="g2">
      <ul class="ticks" style="font-size:8.8pt">
        <li><strong>我们能承诺</strong>每月带来更多高质量的客户联系，并逐条测量</li>
        <li><strong>我们能承诺</strong>每月如实说明什么有效、什么无效，即使答案不中听</li>
      </ul>
      <ul class="ticks grey" style="font-size:8.8pt">
        <li><strong>我们无法承诺</strong>一个具体的营业额数字：它同样取决于中心能服务多少客户</li>
        <li><strong>我们无法承诺</strong>超出接待能力的结果：要超过方案 C，需要更多时间或更多人手</li>
      </ul>
    </div>
  </div>
  <p class="small" style="margin-top:3.5mm">我们的建议是<strong>方案 B</strong>：
  它是唯一一个增长有现有数据支撑、且单位获客成本仍然可控的方案。
  方案 C 可以做到，但需要一起商定后再决定。</p>
"""}
